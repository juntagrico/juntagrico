...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Anteilschein.paid'
        db.add_column(u'my_ortoloco_anteilschein', 'paid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Anteilschein.paid'
        db.delete_column(u'my_ortoloco_anteilschein', 'paid')
