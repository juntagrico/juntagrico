...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Anteilschein.canceled'
        db.add_column(u'my_ortoloco_anteilschein', 'canceled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Boehnli.loco'
        db.alter_column(u'my_ortoloco_boehnli', 'loco_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['my_ortoloco.Loco'], on_delete=models.PROTECT))
        # Deleting field 'Job.earning'
        db.delete_column(u'my_ortoloco_job', 'earning')


    def backwards(self, orm):
        # Deleting field 'Anteilschein.canceled'
        db.delete_column(u'my_ortoloco_anteilschein', 'canceled')


        # Changing field 'Boehnli.loco'
        db.alter_column(u'my_ortoloco_boehnli', 'loco_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['my_ortoloco.Loco'], null=True, on_delete=models.PROTECT))
