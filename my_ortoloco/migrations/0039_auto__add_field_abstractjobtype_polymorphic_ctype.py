...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        id = orm['contenttypes.contenttype'].objects.filter(model = 'jobtype')[0].id
        
        # Adding field 'AbstractJobType.polymorphic_ctype'
        db.add_column(u'my_ortoloco_abstractjobtype', 'polymorphic_ctype',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=id, related_name=u'polymorphic_my_ortoloco.abstractjobtype_set+', null=True, to=orm['contenttypes.ContentType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AbstractJobType.polymorphic_ctype'
        db.delete_column(u'my_ortoloco_abstractjobtype', 'polymorphic_ctype_id')
    ...
    models = {
        ...
        u'my_ortoloco.abstractjobtype': {
            ...
            'polymorphic_ctype': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'polymorphic_my_ortoloco.abstractjobtype_set+'", 'null': 'True', 'to': u"orm['contenttypes.ContentType']"})
        },
