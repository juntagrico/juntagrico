...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Job.reminder_sent'
        db.add_column(u'my_ortoloco_job', 'reminder_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Job.reminder_sent'
        db.delete_column(u'my_ortoloco_job', 'reminder_sent')
