...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Loco.mobile_phone'
        db.add_column(u'my_ortoloco_loco', 'mobile_phone',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Loco.mobile_phone'
        db.delete_column(u'my_ortoloco_loco', 'mobile_phone')
