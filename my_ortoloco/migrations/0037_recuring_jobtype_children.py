...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for abstractJobType in orm.AbstractJobType.objects.all():
            jobType = orm.JobType(abstractjobtype_ptr_id=abstractJobType.id)
            jobType.__dict__.update(abstractJobType.__dict__)
            jobType.save()
