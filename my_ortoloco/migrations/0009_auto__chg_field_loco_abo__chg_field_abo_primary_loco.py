...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Loco.abo'
        db.alter_column(u'my_ortoloco_loco', 'abo_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['my_ortoloco.Abo']))

        # Changing field 'Abo.primary_loco'
        db.alter_column(u'my_ortoloco_abo', 'primary_loco_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['my_ortoloco.Loco']))

    def backwards(self, orm):

        # Changing field 'Loco.abo'
        db.alter_column(u'my_ortoloco_loco', 'abo_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['my_ortoloco.Abo']))

        # Changing field 'Abo.primary_loco'
        db.alter_column(u'my_ortoloco_abo', 'primary_loco_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['my_ortoloco.Loco']))
