...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Anteilschein.user'
        db.delete_column(u'my_ortoloco_anteilschein', 'user_id')

        # Adding field 'Anteilschein.loco'
        db.add_column(u'my_ortoloco_anteilschein', 'loco',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['my_ortoloco.Loco'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


        # Changing field 'Depot.contact'
        db.alter_column(u'my_ortoloco_depot', 'contact_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['my_ortoloco.Loco'], on_delete=models.PROTECT))
        # Removing M2M table for field users on 'Taetigkeitsbereich'
        db.delete_table('my_ortoloco_taetigkeitsbereich_users')

        # Adding M2M table for field locos on 'Taetigkeitsbereich'
        db.create_table(u'my_ortoloco_taetigkeitsbereich_locos', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('taetigkeitsbereich', models.ForeignKey(orm[u'my_ortoloco.taetigkeitsbereich'], null=False)),
            ('loco', models.ForeignKey(orm[u'my_ortoloco.loco'], null=False))
        ))
        db.create_unique(u'my_ortoloco_taetigkeitsbereich_locos', ['taetigkeitsbereich_id', 'loco_id'])


        # Changing field 'Taetigkeitsbereich.coordinator'
        db.alter_column(u'my_ortoloco_taetigkeitsbereich', 'coordinator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['my_ortoloco.Loco'], on_delete=models.PROTECT))
        # Adding field 'Loco.first_name'
        db.add_column(u'my_ortoloco_loco', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default='Hans', max_length=30),
                      keep_default=False)

        # Adding field 'Loco.last_name'
        db.add_column(u'my_ortoloco_loco', 'last_name',
                      self.gf('django.db.models.fields.CharField')(default='Muster', max_length=30),
                      keep_default=False)

        # Adding field 'Loco.email'
        db.add_column(u'my_ortoloco_loco', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='hans.muster@example.com', max_length=75),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Anteilschein.user'
        db.add_column(u'my_ortoloco_anteilschein', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Deleting field 'Anteilschein.loco'
        db.delete_column(u'my_ortoloco_anteilschein', 'loco_id')


        # Changing field 'Depot.contact'
        db.alter_column(u'my_ortoloco_depot', 'contact_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], on_delete=models.PROTECT))
        ...
        # Removing M2M table for field locos on 'Taetigkeitsbereich'
        db.delete_table('my_ortoloco_taetigkeitsbereich_locos')


        # Changing field 'Taetigkeitsbereich.coordinator'
        db.alter_column(u'my_ortoloco_taetigkeitsbereich', 'coordinator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], on_delete=models.PROTECT))
        # Deleting field 'Loco.first_name'
        db.delete_column(u'my_ortoloco_loco', 'first_name')

        # Deleting field 'Loco.last_name'
        db.delete_column(u'my_ortoloco_loco', 'last_name')

        # Deleting field 'Loco.email'
        db.delete_column(u'my_ortoloco_loco', 'email')
    ...
    models = {
        ...
        u'my_ortoloco.taetigkeitsbereich': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'default': "''", 'max_length': '1000'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'locos': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'taetigkeitsbereiche'", 'symmetrical': 'False', 'to': u"orm['my_ortoloco.Loco']"}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100'})
        }
    }
