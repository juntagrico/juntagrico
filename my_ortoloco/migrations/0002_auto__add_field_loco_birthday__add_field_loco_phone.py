...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Loco.birthday'
        db.add_column(u'my_ortoloco_loco', 'birthday',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Loco.phone'
        db.add_column(u'my_ortoloco_loco', 'phone',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Loco.birthday'
        db.delete_column(u'my_ortoloco_loco', 'birthday')

        # Deleting field 'Loco.phone'
        db.delete_column(u'my_ortoloco_loco', 'phone')
