...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.rename_table(u'my_ortoloco_jobtyp', u'my_ortoloco_jobtype')

        db.alter_column(u'my_ortoloco_job', 'typ_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['my_ortoloco.JobType'], on_delete=models.PROTECT))

    def backwards(self, orm):
        db.rename_table(u'my_ortoloco_jobtype', u'my_ortoloco_jobtyp')

        # Changing field 'Job.typ'
        db.alter_column(u'my_ortoloco_job', 'typ_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['my_ortoloco.JobTyp'], on_delete=models.PROTECT))
    ...
    models = {
        ...
        u'my_ortoloco.abo': {
            ...
            'future_extra_abos': ('django.db.models.fields.related.ManyToManyField', [],
                                  {'blank': 'True', 'related_name': "'future_extra_abos'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['my_ortoloco.ExtraAboType']"}),
            'future_size': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'primary_loco': (
            'django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'abo_primary'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': u"orm['my_ortoloco.Loco']"}),
