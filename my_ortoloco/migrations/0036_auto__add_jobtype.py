...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'my_ortoloco_jobtype', (
            (u'abstractjobtype_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['my_ortoloco.AbstractJobType'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'my_ortoloco', ['JobType'])


    def backwards(self, orm):
        # Deleting model 'JobType'
        db.delete_table(u'my_ortoloco_jobtype')
