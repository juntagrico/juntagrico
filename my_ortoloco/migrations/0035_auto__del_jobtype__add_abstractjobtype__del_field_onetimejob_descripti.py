...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Renaming model 'AbstractJobType' to model 'JobType'
        db.rename_table( u'my_ortoloco_abstractjobtype', u'my_ortoloco_jobtype')

        # Adding field 'OneTimeJob.description'
        db.add_column(u'my_ortoloco_onetimejob', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=1000),
                      keep_default=False)

        # Adding field 'OneTimeJob.name'
        db.add_column(u'my_ortoloco_onetimejob', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, unique=True),
                      keep_default=False)

        # Adding field 'OneTimeJob.location'
        db.add_column(u'my_ortoloco_onetimejob', 'location',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'OneTimeJob.duration'
        db.add_column(u'my_ortoloco_onetimejob', 'duration',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=2),
                      keep_default=False)

        # Adding field 'OneTimeJob.bereich'
        db.add_column(u'my_ortoloco_onetimejob', 'bereich',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['my_ortoloco.Taetigkeitsbereich'], on_delete=models.PROTECT),
                      keep_default=False)

        # Adding field 'OneTimeJob.displayed_name'
        db.add_column(u'my_ortoloco_onetimejob', 'displayed_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'OneTimeJob.abstractjobtype_ptr'
        db.delete_column(u'my_ortoloco_onetimejob', u'abstractjobtype_ptr_id')
    ...
    models = {
        ...
        u'my_ortoloco.recuringjob': {
            ...
            u'job_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['my_ortoloco.Job']", 'unique': 'True', 'primary_key': 'True'}),
            'typ': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['my_ortoloco.AbstractJobType']", 'on_delete': 'models.PROTECT'})
        },
