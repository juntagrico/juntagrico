...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Taetigkeitsbereich.hidden'
        db.add_column(u'my_ortoloco_taetigkeitsbereich', 'hidden',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Taetigkeitsbereich.hidden'
        db.delete_column(u'my_ortoloco_taetigkeitsbereich', 'hidden')
