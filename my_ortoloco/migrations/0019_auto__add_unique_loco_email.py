...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Loco', fields ['email']
        db.create_unique(u'my_ortoloco_loco', ['email'])


    def backwards(self, orm):
        # Removing unique constraint on 'Loco', fields ['email']
        db.delete_unique(u'my_ortoloco_loco', ['email'])
