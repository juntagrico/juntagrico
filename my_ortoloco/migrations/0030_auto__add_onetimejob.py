...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OneTimeJob'
        db.create_table(u'my_ortoloco_onetimejob', (
        ...
        db.send_create_signal(u'my_ortoloco', ['OneTimeJob'])


    def backwards(self, orm):
        # Deleting model 'OneTimeJob'
        db.delete_table(u'my_ortoloco_onetimejob')
