...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column(u'my_ortoloco_abo', 'future_groesse', 'future_size')
        db.rename_column(u'my_ortoloco_abo', 'groesse', 'size')

    def backwards(self, orm):
        db.rename_column(u'my_ortoloco_abo', 'size', 'groesse')
        db.rename_column(u'my_ortoloco_abo', 'future_size', 'future_groesse')
