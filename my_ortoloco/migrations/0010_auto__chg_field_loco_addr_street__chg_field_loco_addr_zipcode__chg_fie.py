...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Loco.addr_street'
        db.alter_column(u'my_ortoloco_loco', 'addr_street', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Loco.addr_zipcode'
        db.alter_column(u'my_ortoloco_loco', 'addr_zipcode', self.gf('django.db.models.fields.CharField')(default='', max_length=10))

        # Changing field 'Loco.phone'
        db.alter_column(u'my_ortoloco_loco', 'phone', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'Loco.addr_location'
        db.alter_column(u'my_ortoloco_loco', 'addr_location', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

    def backwards(self, orm):

        # Changing field 'Loco.addr_street'
        db.alter_column(u'my_ortoloco_loco', 'addr_street', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Loco.addr_zipcode'
        db.alter_column(u'my_ortoloco_loco', 'addr_zipcode', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'Loco.phone'
        db.alter_column(u'my_ortoloco_loco', 'phone', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Loco.addr_location'
        db.alter_column(u'my_ortoloco_loco', 'addr_location', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    models = {
        ...
        u'my_ortoloco.abo': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'primary_loco': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'abo_primary'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['my_ortoloco.Loco']"})
        },
        ...
        u'my_ortoloco.loco': {
            ...
            'addr_location': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            'addr_street': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'addr_zipcode': ('django.db.models.fields.CharField', [], {'max_length': '10', 'blank': 'True'}),
