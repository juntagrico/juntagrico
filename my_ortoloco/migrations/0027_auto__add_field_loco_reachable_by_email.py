...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Loco.reachable_by_email'
        db.add_column(u'my_ortoloco_loco', 'reachable_by_email',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Loco.reachable_by_email'
        db.delete_column(u'my_ortoloco_loco', 'reachable_by_email')
