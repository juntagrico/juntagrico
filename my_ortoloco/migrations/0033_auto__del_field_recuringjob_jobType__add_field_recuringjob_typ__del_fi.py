...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'RecuringJob.jobType'
        db.rename_column(u'my_ortoloco_recuringjob', 'jobType_id', 'typ_id')

        # Deleting field 'Job.typ'
        db.delete_column(u'my_ortoloco_job', 'typ_id')


    def backwards(self, orm):
        # Renaming field 'RecuringJob.jobType'
        db.rename_column(u'my_ortoloco_recuringjob', 'typ_id', 'jobType_id')

        # Adding field 'Job.typ'
        db.add_column(u'my_ortoloco_job', 'typ',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['my_ortoloco.JobType'], on_delete=models.PROTECT),
                      keep_default=False)
