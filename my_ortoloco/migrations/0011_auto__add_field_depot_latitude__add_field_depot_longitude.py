...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Depot.latitude'
        db.add_column(u'my_ortoloco_depot', 'latitude',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'Depot.longitude'
        db.add_column(u'my_ortoloco_depot', 'longitude',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Depot.latitude'
        db.delete_column(u'my_ortoloco_depot', 'latitude')

        # Deleting field 'Depot.longitude'
        db.delete_column(u'my_ortoloco_depot', 'longitude')
