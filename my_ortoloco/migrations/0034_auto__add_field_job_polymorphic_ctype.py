...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        id = orm['contenttypes.contenttype'].objects.filter(model = 'recuringjob')[0].id
        
        # Adding field 'Job.polymorphic_ctype'
        db.add_column(u'my_ortoloco_job', 'polymorphic_ctype',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=id, related_name=u'polymorphic_my_ortoloco.job_set+', null=True, to=orm['contenttypes.ContentType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Job.polymorphic_ctype'
        db.delete_column(u'my_ortoloco_job', 'polymorphic_ctype_id')
