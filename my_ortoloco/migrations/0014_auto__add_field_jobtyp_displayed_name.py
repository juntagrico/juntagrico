...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JobTyp.displayed_name'
        db.add_column(u'my_ortoloco_jobtyp', 'displayed_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JobTyp.displayed_name'
        db.delete_column(u'my_ortoloco_jobtyp', 'displayed_name')
