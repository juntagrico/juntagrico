...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RecuringJob'
        db.create_table(u'my_ortoloco_recuringjob', (
            (u'job_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['my_ortoloco.Job'], unique=True, primary_key=True)),
            ('jobType', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['my_ortoloco.JobType'], on_delete=models.PROTECT)),
        ))
        db.send_create_signal(u'my_ortoloco', ['RecuringJob'])


    def backwards(self, orm):
        # Deleting model 'RecuringJob'
        db.delete_table(u'my_ortoloco_recuringjob')
    ...
    models = {
        ...
        u'my_ortoloco.onetimejob': {
            'Meta': {'object_name': 'OneTimeJob', '_ormbases': [u'my_ortoloco.Job']},
            'bereich': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['my_ortoloco.Taetigkeitsbereich']", 'on_delete': 'models.PROTECT'}),
            'description': ('django.db.models.fields.TextField', [], {'default': "''", 'max_length': '1000'}),
            'displayed_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'duration': ('django.db.models.fields.PositiveIntegerField', [], {}),
        ...
        u'my_ortoloco.recuringjob': {
            ...
            'jobType': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['my_ortoloco.JobType']", 'on_delete': 'models.PROTECT'}),
            u'job_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['my_ortoloco.Job']", 'unique': 'True', 'primary_key': 'True'})
        },
