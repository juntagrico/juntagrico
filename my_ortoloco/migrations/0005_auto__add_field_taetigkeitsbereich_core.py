...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Taetigkeitsbereich.core'
        db.add_column(u'my_ortoloco_taetigkeitsbereich', 'core',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Taetigkeitsbereich.core'
        db.delete_column(u'my_ortoloco_taetigkeitsbereich', 'core')
