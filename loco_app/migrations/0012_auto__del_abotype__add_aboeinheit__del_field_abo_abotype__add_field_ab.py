...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'loco_app_abo', 'abotype',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['loco_app.AboType'], on_delete=models.PROTECT),
                      keep_default=False)
    ...
    models = {
        ...
        u'loco_app.abo': {
            ...
            'aboeinheiten': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['loco_app.AboEinheit']", 'null': 'True', 'blank': 'True'}),
        ...
        u'loco_app.aboeinheit': {
            'Meta': {'object_name': 'AboEinheit'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
