...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Depot.street'
        db.delete_column(u'loco_app_depot', 'street')

        # Adding field 'Depot.addr_street'
        db.add_column(u'loco_app_depot', 'addr_street',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'Depot.addr_zipcode'
        db.add_column(u'loco_app_depot', 'addr_zipcode',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10),
                      keep_default=False)

        # Adding field 'Depot.addr_location'
        db.add_column(u'loco_app_depot', 'addr_location',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Adding field 'Loco.addr_street'
        db.add_column(u'loco_app_loco', 'addr_street',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Loco.addr_zipcode'
        db.add_column(u'loco_app_loco', 'addr_zipcode',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Loco.addr_location'
        db.add_column(u'loco_app_loco', 'addr_location',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Depot.street'
        db.add_column(u'loco_app_depot', 'street',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Deleting field 'Depot.addr_street'
        db.delete_column(u'loco_app_depot', 'addr_street')

        # Deleting field 'Depot.addr_zipcode'
        db.delete_column(u'loco_app_depot', 'addr_zipcode')

        # Deleting field 'Depot.addr_location'
        db.delete_column(u'loco_app_depot', 'addr_location')

        # Deleting field 'Loco.addr_street'
        db.delete_column(u'loco_app_loco', 'addr_street')

        # Deleting field 'Loco.addr_zipcode'
        db.delete_column(u'loco_app_loco', 'addr_zipcode')

        # Deleting field 'Loco.addr_location'
        db.delete_column(u'loco_app_loco', 'addr_location')
