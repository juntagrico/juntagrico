...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AboHistory.start'
        db.alter_column(u'loco_app_abohistory', 'start', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'AboHistory.end'
        db.alter_column(u'loco_app_abohistory', 'end', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'AboHistory.start'
        db.alter_column(u'loco_app_abohistory', 'start', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'AboHistory.end'
        db.alter_column(u'loco_app_abohistory', 'end', self.gf('django.db.models.fields.DateTimeField')(null=True))
