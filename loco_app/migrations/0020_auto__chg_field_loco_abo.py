...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'loco_app_loco', 'abo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['loco_app.Abo'], null=True))

    def backwards(self, orm):

        # Changing field 'Loco.abo'
        db.alter_column(u'loco_app_loco', 'abo_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['loco_app.Abo']))
