...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'Log'
        db.delete_table(u'loco_app_abo_users_audit')

        # Adding model 'Abo_users_audit'
        db.create_table(u'loco_app_abo_users_audit', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fm', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['loco_app.Abo'], null=True, blank=True)),
            ('to', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('action', self.gf('django.db.models.fields.CharField')(default='', max_length=20)),
        ))
        db.send_create_signal(u'loco_app', ['Abo_users_audit'])

        # Adding model 'Abo_extra_abos_audit'
        db.create_table(u'loco_app_abo_extra_abos_audit', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fm', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['loco_app.Abo'], null=True, blank=True)),
            ('to', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['loco_app.ExtraAboType'], null=True, blank=True)),
            ('action', self.gf('django.db.models.fields.CharField')(default='', max_length=20)),
        ))
        db.send_create_signal(u'loco_app', ['Abo_extra_abos_audit'])
    ...
    def backwards(self, orm):
        ...
        db.send_create_signal(u'loco_app', ['Log'])

        # Deleting model 'Abo_users_audit'
        db.delete_table(u'loco_app_abo_users_audit')

        # Deleting model 'Abo_extra_abos_audit'
        db.delete_table(u'loco_app_abo_extra_abos_audit')
