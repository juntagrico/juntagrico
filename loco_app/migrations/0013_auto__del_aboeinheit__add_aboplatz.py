...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'AboEinheit'
        db.delete_table(u'loco_app_aboeinheit')

        # Adding model 'Aboplatz'
        db.create_table(u'loco_app_aboplatz', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('abo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['loco_app.Abo'], null=True, blank=True)),
        ))
        db.send_create_signal(u'loco_app', ['Aboplatz'])

        # Removing M2M table for field aboeinheiten on 'Abo'
        db.delete_table('loco_app_abo_aboeinheiten')


    def backwards(self, orm):
        # Adding model 'AboEinheit'
        db.create_table(u'loco_app_aboeinheit', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'loco_app', ['AboEinheit'])

        # Deleting model 'Aboplatz'
        db.delete_table(u'loco_app_aboplatz')

        # Adding M2M table for field aboeinheiten on 'Abo'
        db.create_table(u'loco_app_abo_aboeinheiten', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('abo', models.ForeignKey(orm[u'loco_app.abo'], null=False)),
            ('aboeinheit', models.ForeignKey(orm[u'loco_app.aboeinheit'], null=False))
        ))
        db.create_unique(u'loco_app_abo_aboeinheiten', ['abo_id', 'aboeinheit_id'])
    ...
    models = {
        ...
        u'loco_app.abo': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'primary_user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
        ...
        u'loco_app.aboplatz': {
            'Meta': {'object_name': 'Aboplatz'},
            'abo': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['loco_app.Abo']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
