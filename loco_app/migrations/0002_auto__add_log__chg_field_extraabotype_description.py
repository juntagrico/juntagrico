...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExtraAboType.description'
        db.alter_column(u'loco_app_extraabotype', 'description', self.gf('django.db.models.fields.TextField')(max_length=1000))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ExtraAboType.description'
        db.alter_column(u'loco_app_extraabotype', 'description', self.gf('django.db.models.fields.CharField')(max_length=1000))
    ...
    models = {
        ...
        u'loco_app.log': {
            'Meta': {'object_name': 'Log', 'db_table': "u'loco_app_abo_users_audit'"},
