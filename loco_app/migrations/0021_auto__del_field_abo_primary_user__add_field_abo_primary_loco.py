...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Abo.primary_loco'
        db.add_column(u'loco_app_abo', 'primary_loco',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='abo_primary', null=True, to=orm['loco_app.Loco']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'loco_app_abo', 'primary_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='abo_primary', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)

        # Deleting field 'Abo.primary_loco'
        db.delete_column(u'loco_app_abo', 'primary_loco_id')
