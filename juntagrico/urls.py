...
urlpatterns = [
    ...
    path('my/create/subscription/', juntagrico_cs.cs_start, name='cs-entrypoint'),
    path('my/create/subscription/subscription', juntagrico_cs.cs_select_subscription, name='cs-subscription'),
    path('my/create/subscription/trial', juntagrico_cs.cs_select_trial, name='cs-trial'),
