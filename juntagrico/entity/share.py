...
class Share(Billable):
    ...
    termination_date = models.DateField(_('Gekündigt auf'), null=True, blank=True)
    payback_date = models.DateField(_('Zurückbezahlt am'), null=True, blank=True)
    number = models.IntegerField(_('Anteilschein Nummer'), null=True, blank=True)
    notes = models.TextField(_('Notizen'), max_length=1000, default='', blank=True)
