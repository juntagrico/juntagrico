...
def send_mail(subject, message, to_emails, from_email=None, reply_to_email=None, html_message=None, attachments=None, files=None):
...
class FormEmails:
    ...
    def contact_member(subject, message, member, contact_member, copy_to_member, files):
        ...
        send_mail(subject, message, contact_member.email, reply_to_email=member.email, files=files)
        if copy_to_member:
            send_mail(subject, message, member.email, reply_to_email=member.email, files=files)
    ...
    def internal(subject, message, text_message, emails, files, sender):
        ...
        send_mail(subject, text_content, emails, sender, html_message=html_content, files=files)
