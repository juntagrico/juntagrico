...
class Mailer:
    ...
    def send(msg):
        ...
        def _send_batches(msg, email_batch_size, wait_time_batch):
            ...
            # Send BCC recipients in batches of size email_batch_size with a wait time inbetween wait_time_batch
            ...
            send_batch_email_admin_message = getattr(settings, 'EMAIL_SEND_BATCH_ADMIN_MESSAGE', False)
