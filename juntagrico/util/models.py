...
q_activated = Q(activation_date__isnull=False, activation_date__gte=timezone.now().date())


q_cancelled = Q(cancellation_date__isnull=False, cancellation_date__gte=timezone.now().date())


q_deactivated = Q(deactivation_date__isnull=False, deactivation_date__gte=timezone.now().date())
