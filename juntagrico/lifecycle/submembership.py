...
def check_submembership_parent_dates(instance):
    ...
    if wrong_start:
        raise ValidationError(_('Beitrittsdatum passt nicht zum übergeordneten Aktivierungsdatum'), code='invalid')
    if wrong_end:
        raise ValidationError(_('Austrittsdatum passt nicht zum übergeordneten Deaktivierungsdatum'), code='invalid')
