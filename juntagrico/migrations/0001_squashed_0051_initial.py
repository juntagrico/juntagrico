# Generated by Django 5.2.11 on 2026-03-30 19:39
...
class Migration(migrations.Migration):
    replaces = [('juntagrico', '0001_initial'), ('juntagrico', '0002_auto_20170922_1204'),
                ...
                ('juntagrico', '0009_auto_20180206_1702'), ('juntagrico', '0010_auto_20180210_2142'),
                ('juntagrico', '0011_auto_20180225_1206'), ('juntagrico', '0012_auto_20180509_2300'),
                ('juntagrico', '0013_auto_20180807_2049'), ('juntagrico', '0014_listmessage'),
                ('juntagrico', '0015_auto_20180924_2053'), ('juntagrico', '0016_auto_20190402_0832'),
                ('juntagrico', '0017_auto_20190625_1013'), ('juntagrico', '0018_auto_20191019_2031'),
                ('juntagrico', '0019_auto_20191127_1012'), ('juntagrico', '0020_auto_20200123_1044'),
                ('juntagrico', '0021_auto_20200414_2150'), ('juntagrico', '0022_subscriptionpart'),
                ('juntagrico', '0023_migrate_sub_parts'), ('juntagrico', '0024_auto_20200415_1710'),
                ('juntagrico', '0025_auto_20200708_2236'), ('juntagrico', '0026_auto_20200710_2250'),
                ('juntagrico', '0027_auto_20200921_0817'), ('juntagrico', '0028_subscriptionmembership'),
                ('juntagrico', '0029_auto_20200810_0748'), ('juntagrico', '0030_auto_20201112_0812'),
                ('juntagrico', '0031_pre_1_4'), ('juntagrico', '0032_data_1_4'), ('juntagrico', '0033_post_1_4'),
                ...
                ('juntagrico', '0044_alter_subscriptionmembership_unique_together'), ('juntagrico', '0045_job_members'),
                ...
                ('juntagrico', '0046_alter_depot_options_depotcoordinator_and_more'), ('juntagrico', '0047_pre_743'),
                ('juntagrico', '0048_alter_subscriptionbundle_options_and_more'), ('juntagrico', '0049_data_743'),
                ('juntagrico', '0050_post_743'), ('juntagrico', '0051_tour_weekday')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'Produktgrösse',
                'verbose_name_plural': 'Produktgrössen',
                'ordering': ['sort_order'],
            },
            bases=(models.Model, juntagrico.entity.OldHolder),
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': 'Abo-Pakete',
                'ordering': ['sort_order'],
            },
            bases=(models.Model, juntagrico.entity.OldHolder),
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100, unique=True, verbose_name='Name')),
                ('description', models.TextField(blank=True, default='', verbose_name='Beschreibung')),
                ('weekday', models.PositiveIntegerField(blank=True,
                                                        choices=[(1, 'Montag'), (2, 'Dienstag'), (3, 'Mittwoch'),
                                                                 (4, 'Donnerstag'), (5, 'Freitag'), (6, 'Samstag'),
                                                                 (7, 'Sonntag')], null=True, verbose_name='Wochentag')),
        ...
        migrations.AddField(
            model_name='jobextra',
            name='extra_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='job_types_set',
            ...
            fields=[
                ...
                ('weekday', models.PositiveIntegerField(
                    choices=[(1, 'Montag'), (2, 'Dienstag'), (3, 'Mittwoch'), (4, 'Donnerstag'), (5, 'Freitag'),
                             (6, 'Samstag'), (7, 'Sonntag')], verbose_name='Abholtag')),
                ...
                ('fee',
                 models.DecimalField(decimal_places=2, default=0.0, help_text='Aufpreis für Mitglied', max_digits=9,
                                     verbose_name='Aufpreis')),
                ('description', models.TextField(blank=True, default='', verbose_name='Beschreibung')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('signup_comment', models.TextField(blank=True, default='',
                                                    help_text='Kommentar, den das Mitglied bei der Anmeldung hinterlassen hat',
                                                    verbose_name='Kommentar bei Anmeldung')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sort_order', models.PositiveIntegerField(default=0, verbose_name='Reihenfolge')),
                ('depot',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coordinator_access',
                                   to='juntagrico.depot')),
                ('member', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='depot_access',
        ...
        migrations.AddField(
            model_name='depot',
            name='coordinators',
            field=models.ManyToManyField(related_name='coordinated_depots', through='juntagrico.DepotCoordinator',
                                         to='juntagrico.member', verbose_name='Koordinatoren'),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('can_view_member', models.BooleanField(default=True, verbose_name='Kann Mitglieder sehen')),
                ('can_contact_member', models.BooleanField(default=True, verbose_name='Kann Mitglieder kontaktieren')),
                ('can_remove_member', models.BooleanField(default=True, verbose_name='Kann Mitglieder entfernen')),
                ('can_modify_jobs', models.BooleanField(default=True, verbose_name='Kann Jobs verwalten')),
                ('can_modify_assignments',
                 models.BooleanField(default=True, verbose_name='Kann Einsatzanmeldungen verwalten')),
                ('sort_order', models.PositiveIntegerField(default=0, verbose_name='Reihenfolge')),
                ('area',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coordinator_access',
                                   to='juntagrico.activityarea')),
                ('member', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='area_access',
                                             to='juntagrico.member')),
            ],
            options={
                'verbose_name': 'Koordinator',
        ...
        migrations.AddField(
            ...
            name='coordinators',
            field=models.ManyToManyField(related_name='coordinated_areas', through='juntagrico.AreaCoordinator',
                                         to='juntagrico.member', verbose_name='Koordinatoren'),
        ),
        migrations.AddField(
            model_name='activityarea',
        ...
        migrations.AddField(
            model_name='subscriptionbundle',
            name='category',
            field=models.ForeignKey(blank=True, help_text='Wenn leer, kann dieses Paket nicht bestellt werden.',
                                    null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='bundles',
                                    to='juntagrico.subscriptioncategory', verbose_name='Kategorie'),
        ),
        migrations.AddField(
            model_name='productsize',
            name='product',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sizes',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('required_assignments', models.FloatField(verbose_name='Anz benötigter Arbeitseinsätze')),
                ('required_core_assignments',
                 models.FloatField(default=0, verbose_name='Anz benötigter Kern Arbeitseinsätze')),
                ('price', models.DecimalField(decimal_places=2, max_digits=9, verbose_name='Preis')),
                ('visible', models.BooleanField(default=True, verbose_name='Sichtbar')),
                ('is_extra', models.BooleanField(default=False, verbose_name='Ist Zusatzabo')),
                ...
                ('bundle', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='types',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fee',
                 models.DecimalField(decimal_places=2, default=0.0, help_text='Aufpreis für Mitglied', max_digits=9,
                                     verbose_name='Aufpreis')),
                ('depot', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                            related_name='subscription_type_conditions', to='juntagrico.depot',
                                            verbose_name='Depot')),
                ('subscription_type',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='depot_conditions',
            ...
            fields=[
                ('billable_ptr',
                 models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True,
                                      primary_key=True, serialize=False, to='juntagrico.billable')),
                ('value',
                 models.DecimalField(blank=True, decimal_places=2, default=juntagrico.entity.share.share_value_default,
                ...
                ('reason_for_cancellation', models.PositiveIntegerField(blank=True, choices=[(1, 'Kündigung'), (2,
                                                                                                                'Kündigung und Übertragungserklärung'),
                                                                                             (3, 'Ausschluss'),
                                                                                             (4, 'Tod')], null=True,
            ...
            fields=[
                ...
                ('type',
                 models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='subscription_parts',
                                   to='juntagrico.subscriptiontype', verbose_name='Abo-Typ')),
                ('subscription', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='parts',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='juntagrico.member',
                                             verbose_name='Mitglied')),
                ('subscription',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='juntagrico.subscription',
                                   verbose_name='Abo')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='subscription',
            name='types',
            field=models.ManyToManyField(related_name='subscriptions', through='juntagrico.SubscriptionPart',
                                         to='juntagrico.subscriptiontype'),
        ),
        migrations.AddField(
            model_name='member',
            name='subscriptions',
            field=models.ManyToManyField(related_name='members', through='juntagrico.SubscriptionMembership',
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('depot', 'subscription_type'),
                                               name='unique_depot_subscription_type'),
        ),
        migrations.AddConstraint(
            model_name='delivery',
