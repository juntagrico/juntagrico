# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-03-28 15:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('per_member', models.BooleanField(default=False, verbose_name=b'jeder kann Extra ausw\xc3\xa4hlen')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100, unique=True, verbose_name=b'Name')),
                ('display_empty', models.CharField(max_length=1000, verbose_name=b'Icon f\xc3\xbcr felhlendes Extra')),
                ('display_full', models.CharField(max_length=1000, verbose_name=b'Icon f\xc3\xbcr Extra')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('confirmed', models.BooleanField(default=False, verbose_name=b'best\xc3\xa4tigt')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('required_assignments', models.PositiveIntegerField(verbose_name=b'Anz ben\xc3\xb6tigter Arbeitseins\xc3\xa4tze')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(default=juntagrico.util.temporal.start_of_next_business_year, verbose_name=b'Gew\xc3\xbcnschtes Startdatum')),
            ],
            options={
                'verbose_name': 'Abo',
        ...
        migrations.AddField(
            model_name='assignment',
            name='job_extras',
            field=models.ManyToManyField(blank=True, null=True, related_name='assignments', to='juntagrico.JobExtra'),
        ),
        migrations.AddField(
            model_name='assignment',
            name='member',
