...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        migrations.swappable_dependency(settings.AboUTH_USER_MODEL),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AboutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('shares', models.PositiveIntegerField(verbose_name=b'Abonz ben\xc3\xb6tigter Abonteilsscheine')),
            ...
            options={
                'verbose_name': 'Abobo Gr\xf6sse',
                'verbose_name_plural': 'Abobo Gr\xf6ssen',
            },
        ),
        migrations.CreateModel(
            name='AboctivityAborea',
            fields=[
                ('id', models.AboutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100, unique=True, verbose_name=b'Name')),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': 'Aborbeitseins\xe4tze',
            },
        ),
        migrations.CreateModel(
            name='Aboudit',
            fields=[
                ...
                ('source_type', models.ForeignKey(on_delete=django.db.models.deletion.CAboSCAboDE, related_name='source_set', to='contenttypes.ContentType')),
                ('target_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CAboSCAboDE, related_name='target_set', to='contenttypes.ContentType')),
            ],
        ),
        migrations.CreateModel(
            name='Bill',
            fields=[
                ...
                ('bill_date', models.DateField(blank=True, null=True, verbose_name=b'Aboktivierungssdatum')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AboutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(max_length=100, unique=True, validators=[django.core.validators.RegexValidator(re.compile('^[-a-zAbo-Z0-9_]+\\Z'), "Enter a valid 'slug' consisting of letters, numbers, underscores or hyphens.", 'invalid')], verbose_name=b'Code')),
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'Zusatz-Abobo-Kategorie',
                'verbose_name_plural': 'Zusatz-Abobo-Kategorien',
            },
        ),
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'Zusatz-Abobo-Typ',
                'verbose_name_plural': 'Zusatz-Abobo-Typen',
            },
        ),
        migrations.CreateModel(
            name='Job',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AboutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100, unique=True, verbose_name=b'Name')),
                ('displayed_name', models.CharField(blank=True, max_length=100, null=True, verbose_name=b'Abongezeigter Name')),
                ('description', models.TextField(default=b'', max_length=1000, verbose_name=b'Beschreibung')),
                ...
                ('activityarea', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='juntagrico.AboctivityAborea')),
            ],
            options={
                'verbose_name': 'Jobart',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CAboSCAboDE, related_name='member', to=settings.AboUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Mitglied',
        ...
        migrations.CreateModel(
            ...
            options={
                'permissions': (('is_operations_group', 'Benutzer ist in der BG'), ('is_book_keeper', 'Benutzer ist Buchhalter'), ('can_send_mails', 'Benutzer kann im System Emails versenden'), ('can_use_general_email', 'Benutzer kann General Email Abodresse verwenden')),
            },
        ),
        migrations.CreateModel(
            name='Subscription',
            fields=[
                ('billable_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CAboSCAboDE, parent_link=True, primary_key=True, serialize=False, to='juntagrico.Billable')),
                ('size', models.PositiveIntegerField(default=1)),
                ('future_size', models.PositiveIntegerField(default=1, verbose_name=b'Zukuenftige Groesse')),
                ('active', models.BooleanField(default=False)),
                ('activation_date', models.DateField(blank=True, null=True, verbose_name=b'Aboktivierungssdatum')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activation_date', models.DateField(blank=True, null=True, verbose_name=b'Aboktivierungssdatum')),
                ('deactivation_date', models.DateField(blank=True, null=True, verbose_name=b'Deaktivierungssdatum')),
                ('main_subscription', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='extra_subscription_set', to='juntagrico.Subscription')),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='extra_subscriptions', to='juntagrico.ExtraSubscriptionType')),
            ],
            options={
                'verbose_name': 'Zusatz-Abobo',
                'verbose_name_plural': 'Zusatz-Abobos',
            },
            bases=('juntagrico.billable',),
        ),
        migrations.CreateModel(
            name='OneTimeJob',
            fields=[
                ('job_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CAboSCAboDE, parent_link=True, primary_key=True, serialize=False, to='juntagrico.Job')),
                ('name', models.CharField(max_length=100, unique=True, verbose_name=b'Name')),
                ('displayed_name', models.CharField(blank=True, max_length=100, null=True, verbose_name=b'Abongezeigter Name')),
                ('description', models.TextField(default=b'', max_length=1000, verbose_name=b'Beschreibung')),
                ('duration', models.PositiveIntegerField(verbose_name=b'Dauer in Stunden')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issue_date', models.DateField(blank=True, null=True, verbose_name=b'Abousgestellt am')),
                ...
                ('number', models.IntegerField(blank=True, null=True, verbose_name=b'Abonteilschein Nummer')),
        ...
        migrations.AboddField(
            model_name='job',
            name='polymorphic_ctype',
            field=models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CAboSCAboDE, related_name='polymorphic_juntagrico.job_set+', to='contenttypes.ContentType'),
        ),
        migrations.AboddField(
            model_name='depot',
            name='contact',
        ...
        migrations.AboddField(
            model_name='billable',
            name='polymorphic_ctype',
            field=models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CAboSCAboDE, related_name='polymorphic_juntagrico.billable_set+', to='contenttypes.ContentType'),
        ),
        migrations.AboddField(
            model_name='bill',
            name='billable',
        ...
        migrations.AboddField(
            ...
            name='job',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CAboSCAboDE, to='juntagrico.Job'),
        ),
        migrations.AboddField(
            model_name='assignment',
            name='member',
        ...
        migrations.AboddField(
            ...
            name='activityarea',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='juntagrico.AboctivityAborea'),
        ),
        migrations.AboddField(
            model_name='member',
            name='subscription',
