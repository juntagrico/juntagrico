    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('show_coordinator_phonenumber', models.BooleanField(default=False, verbose_name='Koordinator Tel Nr Veröffentlichen')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(max_length=100, unique=True, validators=[django.core.validators.RegexValidator(re.compile('^[-a-zA-Z0-9_]+\\Z', 32), "Enter a valid 'slug' consisting of letters, numbers, underscores or hyphens.", 'invalid')], verbose_name='Code')),
                ('name', models.CharField(max_length=100, unique=True, verbose_name='Depot Name')),
                ('weekday', models.PositiveIntegerField(choices=[(1, 'Montag'), (2, 'Dienstag'), (3, 'Mittwoch'), (4, 'Donnerstag'), (5, 'Freitag'), (6, 'Samstag'), (7, 'Sonntag')], verbose_name='Wochentag')),
                ('latitude', models.CharField(default='', max_length=100, verbose_name='Latitude')),
                ('longitude', models.CharField(default='', max_length=100, verbose_name='Longitude')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100, unique=True, verbose_name='Name')),
                ('size', models.CharField(default='', max_length=100, verbose_name='Groesse (gross,4, ...)')),
                ('description', models.TextField(max_length=1000, verbose_name='Beschreibung')),
                ('sort_order', models.FloatField(default=1.0, verbose_name='Groesse zum Sortieren')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100, unique=True, verbose_name='Name')),
                ('display_empty', models.CharField(max_length=1000, verbose_name='Icon für felhlendes Extra')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100, unique=True, verbose_name='Name')),
                ('displayed_name', models.CharField(blank=True, max_length=100, null=True, verbose_name='Angezeigter Name')),
                ('description', models.TextField(default='', max_length=1000, verbose_name='Beschreibung')),
                ('duration', models.PositiveIntegerField(verbose_name='Dauer in Stunden')),
                ('location', models.CharField(default='', max_length=100, verbose_name='Ort')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100, unique=True, verbose_name='Name')),
                ('template', models.TextField(default='', max_length=1000, verbose_name='Template')),
                ('code', models.TextField(default='', max_length=1000, verbose_name='Code')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reachable_by_email', models.BooleanField(default=False, verbose_name='Kontaktierbar von der Job Seite aus')),
                ('block_emails', models.BooleanField(default=False, verbose_name='keine emails')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100, unique=True, verbose_name='Name')),
                ('long_name', models.CharField(max_length=100, unique=True, verbose_name='Langer Name')),
                ('size', models.PositiveIntegerField(unique=True, verbose_name='Grösse')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(blank=True, default='', max_length=1000, verbose_name='Notizen')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('future_size', models.PositiveIntegerField(default=1, verbose_name='Zukuenftige Groesse')),
                ('active', models.BooleanField(default=False)),
                ('activation_date', models.DateField(blank=True, null=True, verbose_name='Aktivierungssdatum')),
                ('deactivation_date', models.DateField(blank=True, null=True, verbose_name='Deaktivierungssdatum')),
                ('creation_date', models.DateField(auto_now_add=True, null=True, verbose_name='Erstellungsdatum')),
                ('start_date', models.DateField(default=juntagrico.util.temporal.start_of_next_business_year, verbose_name='Gewünschtes Startdatum')),
            ],
            options={
                'verbose_name': 'Abo',
        ...
        migrations.AddField(
            model_name='jobextra',
            name='extra_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='job_types_set', to='juntagrico.JobExtraType'),
        ),
        migrations.AddField(
            model_name='jobextra',
            name='recuring_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='job_extras_set', to='juntagrico.JobType'),
        ),
        migrations.AddField(
            model_name='job',
        ...
        migrations.AddField(
            ...
            name='type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='periods', to='juntagrico.ExtraSubscriptionType'),
        ),
        migrations.AddField(
            model_name='depot',
            name='contact',
        ...
        migrations.AddField(
            model_name='assignment',
            name='job_extras',
            field=models.ManyToManyField(blank=True, related_name='assignments', to='juntagrico.JobExtra'),
        ),
        migrations.AddField(
            model_name='assignment',
            name='member',
        ...
        migrations.AddField(
            model_name='jobextra',
            name='onetime_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='job_extras_set', to='juntagrico.OneTimeJob'),
        ),
        migrations.AddField(
