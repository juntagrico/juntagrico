# Generated by Django 4.2.23 on 2025-09-13 18:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coordinator_access', to='juntagrico.activityarea')),
                ('member', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='area_access', to='juntagrico.member')),
            ],
            options={
