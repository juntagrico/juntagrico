...
class JuntagricoTestCase(TestCase):
    ...
    @staticmethod
    def create_sub(depot, activation_date=None, parts=None, cancellation_date=None, deactivation_date=None):
        if deactivation_date is not None and cancellation_date is None:
