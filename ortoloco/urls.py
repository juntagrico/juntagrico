...
urlpatterns = patterns('',
    ...
    url('^my/filters/depot', 'my_ortoloco.views.my_filters_depot'),
    url('^my/filters/area', 'my_ortoloco.views.my_filters_area'),
    url('^my/abos$', 'my_ortoloco.views.my_abos'),
    url('^my/abos/depot', 'my_ortoloco.views.my_abos_depot'),
