...
urlpatterns = patterns('',
    ...
    url('^my/kontakt/loco/(?P<loco_id>.*?)/(?P<job_id>.*?)/', 'my_ortoloco.views.my_contact_loco'),
    ...
    url('^my/mails/depot$', 'my_ortoloco.views.my_mails_depot'),
    url('^my/mails/area$', 'my_ortoloco.views.my_mails_area'),
    url('^my/mails/send$', 'my_ortoloco.views.send_email'),
    url('^my/mails/send/depot$', 'my_ortoloco.views.send_email_depot'),
    url('^my/mails/send/area$', 'my_ortoloco.views.send_email_area'),
    url('^my/depotlisten', 'my_ortoloco.views.my_depotlisten'),
    url('^my/email/export', 'my_ortoloco.views.my_excel_export'),
    ...
    url('^my/filters/depot/(?P<depot_id>.*?)/', 'my_ortoloco.views.my_filters_depot'),
    url('^my/filters/area/(?P<area_id>.*?)/', 'my_ortoloco.views.my_filters_area'),
    url('^my/abos$', 'my_ortoloco.views.my_abos'),
    url('^my/abos/depot/(?P<depot_id>.*?)/', 'my_ortoloco.views.my_abos_depot'),
