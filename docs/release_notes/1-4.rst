...
* Admin Features:
    ...
    * Documentation on :ref:`Permissions <reference-permissions>`
* Fixes:
    * Fix in share payout
...
* Developer Features:
    ...
    * Added possibility to enable rich text fields in description fields. For configuration see :ref:`Rich Text Editor <intro-rich-text-editor>`
